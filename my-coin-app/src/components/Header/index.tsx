...
export default function Header() {
  return (
    <div
      className='fixed flex w-full items-center justify-center p-0 shadow-lg'
      style={{ height: 50, backgroundColor: colors.background }}
    >
      <div style={{ width: '1400px', padding: '0 20px' }}>
        <Grid container>
          <Grid item xs={2}>
            <span className='flex items-center justify-start text-xl font-bold' style={{ color: colors.primary }}>
              MyCoin
            </span>
          </Grid>
